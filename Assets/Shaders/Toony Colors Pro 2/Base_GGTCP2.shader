...
Shader "Base_GGTCP2"
{
	Properties
	{
		...
		[TCP2ColorNoAlpha] [HDR] _Emission ("Emission Color", Color) = (0,0,0,1)
		 [NoScaleOffset] _EmissionMask ("Emission Color", 2D) = "white" {}
		[TCP2Separator]
	...
	SubShader
	{
		...
		#pragma shader_feature_local _ _ALPHAPREMULTIPLY_ON
			...
			) : SV_Target
			{
				...
				float3 __emission = ( _Emission.rgb * TCP2_TEX2D_SAMPLE(_EmissionMask, _EmissionMask, input.pack0.xy).ggg );
