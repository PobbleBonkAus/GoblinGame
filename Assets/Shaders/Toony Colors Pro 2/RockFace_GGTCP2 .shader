	...
	SubShader
	{
		...
		#pragma shader_feature_local _ _ALPHAPREMULTIPLY_ON
			...
			) : SV_Target
			{
				...
				float __stylizedThreshold = ( TCP2_TEX2D_SAMPLE(_StylizedThreshold, _StylizedThreshold, input.pack2.xy * _StylizedThreshold_ST.xy + _StylizedThreshold_ST.zw).a );
